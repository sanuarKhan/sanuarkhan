...
function Navbar() {
  ...
  return (
    <nav className="scale-up-top flex justify-center  z-10  text-slate-800 fixed bg-transparent p-6">
      <div className="container mx-auto flex justify-around lg:gap-60 items-center">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          <span
            id="logo"
            className="font-semibold text-sm lg:text-xl tracking-tight"
          >
            Sanuar Khan
          </span>
        </div>
        ...
        <div className="hidden md:flex  flex-grow lg:flex lg:items-center lg:w-auto">
          ...
          <button class="hidden md:flex bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded justify-end  items-center">
            ...
            <Link href="https://docs.google.com/document/d/1zfK4LoRGhsXiTIyAYJGtrLynA-MFTss1iKcJrUMoK40/edit?usp=sharing">
              <span>Download</span>{" "}
            </Link>
          </button>
        </div>
